...
# Accelerometer:    12.500HZ = 1/25th sec
# Gyroscope:        25.000Hz = 1/12th sec
...
# Splitting the data_resampled by day (grouping the dataframe by each day)
